...
CREATE TABLE ih_order_info (
    ...
    oi_begin_date datetime NOT NULL COMMENT '入住时间',
    oi_end_date datetime NOT NULL COMMENT '离开时间',
    oi_days int NOT NULL COMMENT '入住天数',
    oi_house_price int NOT NULL COMMENT '房屋单价，单位分',
    oi_amount int NOT NULL COMMENT '订单金额，单位分',
    oi_status tinyint NOT NULL DEFAULT '0' COMMENT '订单状态，0-待接单，1-待支付，2-已支付，3-已完成，4-已取消，5-拒接单',
